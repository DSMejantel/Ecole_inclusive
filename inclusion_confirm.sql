...
DELETE FROM inclusion WHERE eleve_id=$eleve_edit;
-- Insère l'affectation à un dispositif
INSERT INTO inclusion(eleve_id, classe_id)
SELECT
$eleve_edit as eleve_id,
CAST(value AS integer) as classe_id from json_each(:inc) WHERE :inc IS NOT NULL
