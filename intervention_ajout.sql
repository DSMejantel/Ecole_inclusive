...
SELECT 'form' as component, 
    ...
    SELECT 'Nature' AS label, 'nature' AS name, 'select' as type,'[{"label": "ESS", "value": "ESS"}, {"label": "Info", "value": "Info"}, {"label": "RDV", "value": "RDV"}, {"label": "Courrier", "value": "Courrier"}]' as options, 4 as width;
